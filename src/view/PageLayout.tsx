...
const PageLayout: React.FC = () => {
    ...
    return (
        <>
            <div className="max-width-560px bg-white border-radius-md-10 h-56px h-md-40px d-flex align-items-center justify-content-center mt-16px">
                        ...
                        <>
                            <li>
                                <span className="d-flex p-12px cursor-pointer">
                                    <svg onClick={() => setCurrPage(1)} xmlns="http://www.w3.org/2000/svg" width="13.414" height="8.829" viewBox="0 0 13.414 8.829">
                            ...
                            <li>
                                <span onClick={() => setCurrPage(currPage - 1)} className="d-flex p-12px cursor-pointer">
                    ...
                    {renderPageNumbers()}
                    {
                        currPage == storage.lastPage ? <></>
                            ...
                            <>
                                ...
                                <li>
                                    <span onClick={() => setCurrPage(storage.lastPage)} className="d-flex p-12px cursor-pointer">
